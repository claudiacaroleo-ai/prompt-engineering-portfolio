...
**Target Domain**: Luxury Fashion & Retail (Prada Group context)
...
- ✅ Comparative Security Analysis (GPT-4, Claude, Gemini)
...
- Defensive prompt design (blue team)
- Python automation & API integration
- Security assessment methodology

**Domain Expertise**:
- Luxury retail AI risk understanding
- Customer privacy & IP protection
- Brand reputation risk mitigation

## 📂 Project Structure
```
ai-security-luxury/
├── attack-vectors/       # 50+ test cases categorized by attack type
├── testing-framework/    # Python scripts for automated testing
├── defense-library/      # Secure prompt templates
├── results/             # Test execution results & analysis
