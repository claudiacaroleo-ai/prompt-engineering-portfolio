...
A Python script (`extract\_and\_sample.py`) is used to generate a balanced evaluation dataset with the following rules:
...
\- The model only sees `review\_text`
...
results/predictions\_zero\_shot.csv
...
prompts/few\_shot\_failure\_aware.md
...
results/predictions\_few\_shots\_generic.csv

results/predictions\_few\_shots\_failure\_aware.csv
